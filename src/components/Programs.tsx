    ...
    <section id="programs" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">Heart4Change Programs</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="bg-white rounded-xl shadow-lg p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Women's Empowerment</h3>
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                <span className="h-2 w-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
                <span className="text-gray-700">"Boundaries" workshops for over 3,000 women in Kisii</span>
              </li>
              <li className="flex items-start space-x-3">
                <span className="h-2 w-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
                <span className="text-gray-700">Information on economic empowerment programs</span>
              </li>
              <li className="flex items-start space-x-3">
                <span className="h-2 w-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
                <span className="text-gray-700">Linking women with supporting organizations</span>
              </li>
            </ul>
          </div>

          <div className="bg-white rounded-xl shadow-lg p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Scholarship Program</h3>
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                <span className="h-2 w-2 bg-green-600 rounded-full mt-2 flex-shrink-0"></span>
                <span className="text-gray-700">Over 55 students sponsored through all education levels</span>
              </li>
              <li className="flex items-start space-x-3">
                <span className="h-2 w-2 bg-green-600 rounded-full mt-2 flex-shrink-0"></span>
                <span className="text-gray-700">More than 2,000 learners received exam supplies</span>
              </li>
              <li className="flex items-start space-x-3">
                <span className="h-2 w-2 bg-green-600 rounded-full mt-2 flex-shrink-0"></span>
                <span className="text-gray-700">Focus on bright, needy students unable to afford education</span>
              </li>
            </ul>
          </div>
        </div>
